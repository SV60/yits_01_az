...
export default function Footer() {
    return (
        ...
        <div className='flex flex-col gap-[10px]'>
            <div className='flex text-lg font-bold gap-[3px]'>
                <p>Welcome to</p>
            ...
            <div className='text-sm'>Copyright © MeeeCloud 2025</div>
        </div>
        <div className='flex items-center ml-[10px] gap-6'>
            ...
            <a target="_blank" href="https://t.me/meeecloud" rel="noopener noreferrer">
                <i className="fa-brands fa-telegram text-white text-[40px] opacity-50 hover:opacity-100" alt="Telegram Icon"></i>
            </a>
        </div>
    </div>
    )
